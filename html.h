...
".v{width:50px;text-align:center;font-size:12px}"
"a{text-decoration:none;}"
"a:hover.a,a:hover.b{text-decoration:underline;color:#D00}"
".a,.f{color:#369}"
".b,.c,.d,.e,.t{color:#888}"
".c{font-size:10px}"
".d{font-size:12px}"
...
"a:hover.e{text-decoration:underline}"
".e{font-weight:bold}"
".b1{color:#000}"
".b2{color:#D00}"
...
".r1{color:#F96}"
".s1{color:#99F}"
".p,.q,.r,.s{font-size:0px;padding:10px;line-height:20px}"
/*".p{background-image:url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='20'><path fill='%23AAA' d='M0,16 10,0 20,16 10,12z'/></svg>\")}"
".q{background-image:url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='20'><path fill='%23AAA' d='M0,4 10,20 20,4 10,8z'/></svg>\")}"
".r{background-image:url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='20'><path fill='%23F96' d='M0,16 10,0 20,16 10,12z'/></svg>\")}"
".s{background-image:url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='20'><path fill='%2399F' d='M0,4 10,20 20,4 10,8z'/></svg>\")}"*/
".p{background-image:url(\"data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIyMCI+PHBhdGggZmlsbD0iI0FBQSIgZD0iTTAsMTYgMTAsMCAyMCwxNiAxMCwxMnoiLz48L3N2Zz4=\")}"
".q{background-image:url(\"data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIyMCI+PHBhdGggZmlsbD0iI0FBQSIgZD0iTTAsNCAxMCwyMCAyMCw0IDEwLDh6Ii8+PC9zdmc+\")}"
".r{background-image:url(\"data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIyMCI+PHBhdGggZmlsbD0iI0Y5NiIgZD0iTTAsMTYgMTAsMCAyMCwxNiAxMCwxMnoiLz48L3N2Zz4=\")}"
".s{background-image:url(\"data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIyMCI+PHBhdGggZmlsbD0iIzk5RiIgZD0iTTAsNCAxMCwyMCAyMCw0IDEwLDh6Ii8+PC9zdmc+\")}"
